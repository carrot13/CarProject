...
CarQuery.prototype = {
    ...
    search: function()
    {
    	...
    	$.getJSON(this.base_url+"?callback=?", {
    	  ...
    	  {		
			...
			$(a).bind('click', {model_id:model_id}, function(event) {
                ...
                $(a).html(trims[i].model_year + ' ' + trims[i].make_display + ' ' + trims[i].model_name + ' ' + trims[i].model_trim).attr("href", "#");
		...
		$(div).append(ul);
		console.log(sender.search_results_id);
